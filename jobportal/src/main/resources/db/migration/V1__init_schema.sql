...
-- 1) Słowniki i tabele bazowe, od których zależą inne
...
-- 4) Tabele zależne od company/location/users
...
-- 5) Tabele zależne od job_post_activity i job_seeker_profile
